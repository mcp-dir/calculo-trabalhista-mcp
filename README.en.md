...
### Labor claim updates with official indices, for AI

**Brazilian labor calculation** for AI. Update labor claims and awards with official correction, interest and the period's minimum wage. Live indices and minimum wage, no login.

- 👷 **Updates labor claims** with correction, interest and minimum wage
...
**Manual** (if the deeplink does not open): [claude.ai/customize/connectors](https://claude.ai/customize/connectors?surface=cowork) → **+** → **Add custom connector** → paste **Name** `Cálculo Trabalhista` and **URL** `https://api.mcp.ai/p_calculo-trabalhista`.

### Cursor

[➕ Install Cálculo Trabalhista in Cursor](cursor://anysphere.cursor-deeplink/mcp/install?name=calculotrabalhista&config=eyJ1cmwiOiJodHRwczovL2FwaS5tY3AuYWkvcF9jYWxjdWxvLXRyYWJhbGhpc3RhIn0=)

### VS Code (Copilot Chat)

[➕ Install Cálculo Trabalhista in VS Code](vscode:mcp/install?name=calculotrabalhista&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fapi.mcp.ai%2Fp_calculo-trabalhista%22%7D)
...
```
Update a R$18,000 labor award since 2022 with interest and correction
What was the minimum wage in effect in March 2023?
```
...
MIT — see [LICENSE](LICENSE). The MCP server at `api.mcp.ai/p_calculo-trabalhista` is proprietary (hosted); this repo (manifests, docs, skills) is MIT.
