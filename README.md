...
### Atualização de verbas trabalhistas com índices oficiais, para IA

**Cálculo trabalhista** para IA. Atualize verbas e condenações da Justiça do Trabalho com correção oficial, juros e o salário mínimo do período. Índices e salário mínimo ao vivo, sem login.

- 👷 **Atualiza verbas trabalhistas** com correção, juros e salário mínimo
...
**Manual** (se o deeplink não abrir): [claude.ai/customize/connectors](https://claude.ai/customize/connectors?surface=cowork) → **+** → **Adicionar conector personalizado** → cole **Nome** `Cálculo Trabalhista` e **URL** `https://api.mcp.ai/p_calculo-trabalhista`.

### Cursor

[➕ Instalar Cálculo Trabalhista no Cursor](cursor://anysphere.cursor-deeplink/mcp/install?name=calculotrabalhista&config=eyJ1cmwiOiJodHRwczovL2FwaS5tY3AuYWkvcF9jYWxjdWxvLXRyYWJhbGhpc3RhIn0=)

### VS Code (Copilot Chat)

[➕ Instalar Cálculo Trabalhista no VS Code](vscode:mcp/install?name=calculotrabalhista&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fapi.mcp.ai%2Fp_calculo-trabalhista%22%7D)
...
```
https://api.mcp.ai/p_calculo-trabalhista
```
...
```
Atualize uma condenação trabalhista de R$ 18.000 desde 2022 com juros e correção
Qual era o salário mínimo vigente em março de 2023?
```
...
- 📧 [calculotrabalhista@mcp.ai](mailto:calculotrabalhista@mcp.ai)
- 🐛 [GitHub Issues](https://github.com/mcp-dir/calculo-trabalhista-mcp/issues)
- 📄 [docs/](docs/)
...
MIT — veja [LICENSE](LICENSE). O servidor MCP em `api.mcp.ai/p_calculo-trabalhista` é proprietário (hosted); este repositório (manifestos, docs, skills) é MIT.
