...
Cálculo Trabalhista segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Banco Central do Brasil (BACEN SGS)** | BR | fonte pública de índices/taxas |
| **IBGE** | BR | fonte pública de índices (IPCA/INPC) |
| **IPEADATA** | BR | fonte pública (salário mínimo) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [calculotrabalhista@mcp.ai](mailto:calculotrabalhista@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
